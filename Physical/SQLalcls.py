...
import scrape_BS
from scrape_BS import scraping_allascii, SQLclsdict_allascii, SQLclsdict_convfact
...
NISTPhysicalConstant = Row("NISTPhysicalConstant", Base, SQLclsdict_allascii('./Physical/rawdata/allascii.txt'))
