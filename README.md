...
Physical requires (minimally) <i>requests, BeautifulSoup</i> for the webscraping.  
For databasing and querying, I used <i>SQLAlchemy</i>.  I highly recommend having a SQL database to have all querying features available; I used <i>PostgreSQL</i>.   
